...
<main>
    ...
    <section class="sponsors">
        ...
        <div>
			<a href="http://www.vrede.be"><img style="height: 20em; width: 40em;" src="{{ base_url('assets/images/Vrede.jpg') }}" alt="Vrede.be"></a>
            <a href="https://www.akzonobel.com/nl/"><img style="height: 20em; width: 20em;" src="{{ base_url('assets/images/AkzoNobelTormorrowsAnswersToday.jpg') }}" alt="AkzoNobel Tormorrow's Answers Today"/></a>
            <a href="http://www.garageteirlynck.be/"><img style="height: 20em; width: 20em;" src="{{ base_url('assets/images/GarageTeirlynckWaregem.jpg') }}" alt="Garage Teirlynck Waregem"/></a>
        </div>
    </section>
</main>
